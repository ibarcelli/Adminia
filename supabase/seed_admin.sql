...
--   2. Email: admin@adminia.pe (o el email que prefieras)
...
--   2. Pegar este SQL
--   3. Reemplazar 'REEMPLAZAR-CON-UUID-DEL-USUARIO' con el UUID real
--   4. Click en Run
-- ============================================================
...
VALUES (
  'REEMPLAZAR-CON-UUID-DEL-USUARIO',  -- ← UUID del usuario creado en Authentication
  'admin@adminia.pe',                   -- ← mismo email usado en Authentication
  'admin',
